...
function ClassesTutors() {
  ...
  return (
    <MaxWidthWrapper className="tw:container">
      <div className="tw:flex tw:items-center tw:justify-center tw:h-screen tw:max-h-[795px] tw:gap-11 tw:w-full">
        <div className="tw:w-full tw:flex tw:items-center tw:justify-center tw:relative">
          <div className="tw:absolute tw:-top-20">
            <svg width="420" height="423" viewBox="0 0 391 377" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <ResponsiveContainer
            ...
            render={(parentWidth, carouselRef) => {
              ...
              return (
                <StackedCarousel
                  className="tw:!h-96 tw:!overflow-visible"
                  swipeSpeed={0.5}
                  ref={carouselRef}
                  slideComponent={CarouselItem}
                  slideWidth={parentWidth < 600 ? parentWidth - 40 : 400}
        ...
        <div className="tw:!space-y-6 tw:w-full tw:relative tw:z-1">
          ...
          <p className="tw:text-muted-foreground tw:-tracking-tighter tw:text-lg tw:text-balance">
            VizSchool LMS offers engaging courses for all ages, guided by expert tutors. Interactive virtual classrooms and personalized support
            empower students to learn and grow at their own pace.
          </p>
        </div>
      </div>
    </MaxWidthWrapper>
